...
def main(args):
    ...
    try:
        ...
        msg = build_mantis_home_command_set(
            # mantis.robot_label, command_type="HOME_MANTIS_FIRST_CODE", distance_to_dm_codes=250, distance_between_dm_codes=5)
            mantis.robot_label, command_type="HOME_MANTIS_FIRST_CODE", distance_to_dm_codes=1010, distance_between_dm_codes=1)
