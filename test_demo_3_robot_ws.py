...
FLOW_INIT_POS = 1348266
C1 = Cell(605, -1016)
C2 = Cell(2625, -1770)  # P&D
C3 = Cell(13785, 1016)
...
def load_full_script() -> list[dict]:
    return [
        # - ANT GO TO WORKSTATION 2 AND PICK THE TOTE
        {
            "ANT": [
        ...
        # - ANT GO TO WORKSTATION 2 AND DROP THE TOTE
        # - ANT GO TO CHARGER
        {
            "ANT": [
                # CHARGER
        ...
        while True:
            ...
            for step in load_full_script():
                ...
                ladder_spyder_thread = threading.Thread(
                    ...
                    args=(ladder, spyder, path_ladder_spyder,
                          mqtt_client, helper, ssh),
                    daemon=True
                )
