...
topic = "robot/commandSet/create/A203"

init_y = 115000
target_y = 115000 - 12600

step = (target_y - init_y) // 3  # 移动距离可以被3整除


payload_3 = {
    "robotCommandSetLabel": "A100-S9",
...
payload_json_3 = json.dumps(payload_3)

# 发布消息
client.publish(
    topic=topic, payload=payload_json_3, qos=2, retain=False)
