...
def main(args):
    ...
    try:
        for i in range(args.cycle_count):
            ...
            distanceToadjust = -1 if i % 2 == 0 else 1
            msg = build_ladder_home_command_set(
                ladder.robot_label, command_type="HOME_LADDER_ADJUST", distance_to_adjust=distanceToadjust)
            ...
            msg = build_robot_command_set(ladder.robot_label, "RESET")
