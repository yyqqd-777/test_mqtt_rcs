...
test_cases_load = [
    {"type": "ARTICULATE_FINGERS", "fingers": [0, 0, 0, 0, 0, 0, 0, 0]},
    {
        ...
        "expect": {
            "loadSensors": {"frontInner": False, "frontOuter": False, "rearInner": False, "rearOuter": False},
    ...
    {"type": "ARTICULATE_FINGERS", "fingers": [9000, 0, 0, 0, 9000, 0, 0, 0]},
    {
        ...
        "expect": {"loadSensors": {"frontInner": False, "frontOuter": False, "rearInner": False, "rearOuter": False}},
        "future": {}
    },
    {
        "type": "MOVE_ARMS", "arm_position": 0, "max_velocity": 1000, "max_acceleration": 1000,
        "expect": {"loadSensors": {"frontInner": True, "frontOuter": False, "rearInner": True, "rearOuter": True}},
        "future": {"loadSensors": {"frontInner": True, "frontOuter": False, "rearInner": True, "rearOuter": True}},
    },
    {"type": "ARTICULATE_FINGERS", "fingers": [0, 0, 0, 0, 0, 0, 0, 0]},
]
...
# 下箱测试用例：按顺序执行的动作序列
test_cases_unload = [
    {"type": "ARTICULATE_FINGERS", "fingers": [0, 0, 9000, 0, 0, 0, 9000, 0]},
    {
        "type": "MOVE_ARMS", "arm_position": -800, "max_velocity": 800, "max_acceleration": 500,
        "expect": {
            "loadSensors": {"frontInner": True, "frontOuter": False, "rearInner": True, "rearOuter": True},
            # "endOfArmSensors": {"rearRightOuter": False, "rearRightInner": False, "rearLeftInner": False, "rearLeftOuter": False},
        },
        "future": {"loadSensors": {"frontInner": False, "frontOuter": False, "rearInner": False, "rearOuter": False}},
    },
